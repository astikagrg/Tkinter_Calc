...
button_mul = Button(root, text='x', command=lambda : button_cal('*'), font=('Gungsuh', 30), fg='hot pink' , bg='black',)
button_div = Button(root, text='/', command=lambda : button_cal('/'), font=('Gungsuh', 30), fg='hot pink' , bg='black',)
button_exp = Button(root, text='^', command=lambda : button_cal('**'), font=('Gungsuh', 30), fg='hot pink', bg='black',)
button_mod = Button(root, text='mod', command=lambda : button_cal('%'), font=('Gungsuh', 20), fg='hot pink', bg='black',)
button_equ = Button(root, text='=', command=button_eq, font=('Gungsuh', 30), fg='Yellow', bg='black',)
