...
button_0 = Button(root, text='0', command=lambda: button_cal(0), font=('Gungsuh', 30), fg='hot pink', bg='black',
...
button_9 = Button(root, text='9', command=lambda: button_cal(9), font=('Gungsuh', 30), fg='hot pink', bg='black',
                  activeforeground='white', activebackground='black')
button_dec = Button(root, text='.', command=lambda: button_cal('.'), font=('Gungsuh', 30), fg='cyan', bg='black', )
button_add = Button(root, text='+', command=lambda: button_cal('+'), font=('Gungsuh', 30), fg='cyan', bg='black', )
button_sub = Button(root, text='-', command=lambda: button_cal('-'), font=('Gungsuh', 30), fg='cyan', bg='black', )
button_mul = Button(root, text='x', command=lambda: button_cal('*'), font=('Gungsuh', 30), fg='cyan', bg='black', )
button_div = Button(root, text='/', command=lambda: button_cal('/'), font=('Gungsuh', 30), fg='cyan', bg='black', )
button_exp = Button(root, text='^', command=lambda: button_cal('**'), font=('Gungsuh', 30), fg='cyan', bg='black', )
button_mod = Button(root, text='mod', command=lambda: button_cal('%'), font=('Gungsuh', 20), fg='cyan', bg='black', )
button_equ = Button(root, text='=', command=button_eq, font=('Gungsuh', 30), fg='cyan', bg='black', )
button_clear = Button(root, text='Clear', command=button_clear, font=('Gungsuh', 20), fg='yellow', bg='black', )
